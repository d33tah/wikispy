...
"""
Imports data generated by etree.py to the WikiSpy database.

EXAMPLE USAGE:

7z x -so plwiki-20150219-pages-meta-history1.xml.7z 2>&1 | ./etree.py | \
    ./bulkload.py plwiki pl wikipedia.org
